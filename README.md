...
Esse é o link do meu protótipo do figma https://www.figma.com/file/q6D0QpX31yM0HBq5wdKX4Q/gerenciador-de-estoque?type=design&node-id=0-1&mode=design&t=DB8XFltwEjT0kmm1-0
...
- [x] ID 04 - Implementa um layout fluido e responsivo utilizando unidades de viewport relativas (vw, vh,rem) em vez de unidades fixas (px) para criar uma experiência de usuário consistente em diferentes dispositivos e tamanhos de tela.
